 ...
 */
package org.numixproject.hermes.command;

import java.util.HashMap;

import org.numixproject.hermes.command.handler.AMsgHandler;
import org.numixproject.hermes.command.handler.AwayHandler;
import org.numixproject.hermes.command.handler.BackHandler;
import org.numixproject.hermes.command.handler.CloseHandler;
import org.numixproject.hermes.command.handler.DCCHandler;
import org.numixproject.hermes.command.handler.DeopHandler;
import org.numixproject.hermes.command.handler.DevoiceHandler;
import org.numixproject.hermes.command.handler.EchoHandler;
import org.numixproject.hermes.command.handler.HelpHandler;
import org.numixproject.hermes.command.handler.JoinHandler;
import org.numixproject.hermes.command.handler.KickHandler;
import org.numixproject.hermes.command.handler.MeHandler;
import org.numixproject.hermes.command.handler.ModeHandler;
import org.numixproject.hermes.command.handler.MsgHandler;
import org.numixproject.hermes.command.handler.NamesHandler;
import org.numixproject.hermes.command.handler.NickHandler;
import org.numixproject.hermes.command.handler.NoticeHandler;
import org.numixproject.hermes.command.handler.OpHandler;
import org.numixproject.hermes.command.handler.PartHandler;
import org.numixproject.hermes.command.handler.QueryHandler;
import org.numixproject.hermes.command.handler.QuitHandler;
import org.numixproject.hermes.command.handler.RawHandler;
import org.numixproject.hermes.command.handler.TopicHandler;
import org.numixproject.hermes.command.handler.VoiceHandler;
import org.numixproject.hermes.command.handler.WhoisHandler;
