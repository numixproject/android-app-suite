...
import com.numix.calculator_pro.BaseModule.Mode;

public class CalculatorWidget extends AppWidgetProvider {
    public final static String PREFERENCE_WIDGET_PREAMBLE = "com.numix.calculator_pro.pro.CALC_WIDGET_VALUE_";
    public static final String DIGIT_0 = "com.numix.calculator_pro.pro.0";
    public static final String DIGIT_1 = "com.numix.calculator_pro.pro.1";
    public static final String DIGIT_2 = "com.numix.calculator_pro.pro.2";
    public static final String DIGIT_3 = "com.numix.calculator_pro.pro.3";
    public static final String DIGIT_4 = "com.numix.calculator_pro.pro.4";
    public static final String DIGIT_5 = "com.numix.calculator_pro.pro.5";
    public static final String DIGIT_6 = "com.numix.calculator_pro.pro.6";
    public static final String DIGIT_7 = "com.numix.calculator_pro.pro.7";
    public static final String DIGIT_8 = "com.numix.calculator_pro.pro.8";
    public static final String DIGIT_9 = "com.numix.calculator_pro.pro.9";
    public static final String DOT = "com.numix.calculator_pro.pro.dot";
    public static final String PLUS = "com.numix.calculator_pro.pro.plus";
    public static final String MINUS = "com.numix.calculator_pro.pro.minus";
    public static final String MUL = "com.numix.calculator_pro.pro.mul";
    public static final String DIV = "com.numix.calculator_pro.pro.div";
    public static final String EQUALS = "com.numix.calculator_pro.pro.equals";
    public static final String CLR = "com.numix.calculator_pro.pro.clear";
    public static final String DEL = "com.numix.calculator_pro.pro.delete";
    public static final String SHOW_CLEAR = "com.numix.calculator_pro.pro.show_clear";
