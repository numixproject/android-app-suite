package com.numix.calculator_pro.view;
...
import com.numix.calculator_pro.Preferences;
                ...
                public boolean onPreferenceChange(Preference preference, Object newValue) {
                    if((Boolean) newValue != CalculatorSettings.useLightTheme(getActivity())) {
                        ...
                        getActivity().getPackageManager().setComponentEnabledSetting(
                                new ComponentName("com.numix.calculator_pro", "com.numix.calculator_pro.Calculator-Light"), lightState,
                                PackageManager.DONT_KILL_APP);
                        getActivity().getPackageManager().setComponentEnabledSetting(
                                new ComponentName("com.numix.calculator_pro", "com.numix.calculator_pro.Calculator-Dark"), darkState,
                                PackageManager.DONT_KILL_APP);
